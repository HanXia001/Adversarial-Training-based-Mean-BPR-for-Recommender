...
class BPR:
    ...
    reg = 0.01
    train_count = 1000
    train_data_path = "ydata-ymusic-rating-study-v1_0-train.txt" #'u5.base'
    test_data_path = "ydata-ymusic-rating-study-v1_0-test.txt" # 'u5.test'
    ...
    def load_data(self, path):
        line_num = 0
        train_file = open("ydata-ymusic-rating-study-v1_0-train_50.txt","w")
    ...
    def load_test_data(self, path):
        line_num = 0
        test_file = open("ydata-ymusic-rating-study-v1_0-test_50.txt", "w")
        with open(path, 'r') as f:
            for line in f.readlines():
                if line_num % 2 == 0:
