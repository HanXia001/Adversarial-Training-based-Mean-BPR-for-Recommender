...
def topK_scores(test, predict, topk, user_count, item_count):
    ...
    print('Prec@%d:'%(re_count+1), PrecisionSum[re_count] / total_test_data_count) #
    print('Rec@%d:'%(re_count+1), RecallSum[re_count] / total_test_data_count)
    print('F1@%d:'%(re_count+1), F1Sum[re_count] / total_test_data_count)
    print('NDCG@%d:'%(re_count+1), NDCGSum[re_count] / total_test_data_count)
    print('1-call@%d:'%(re_count+1), OneCallSum[re_count] / total_test_data_count)
    return  MAPSum / total_test_data_count, MRRSum / total_test_data_count,PrecisionSum[re_count] / total_test_data_count,RecallSum[re_count] / total_test_data_count,F1Sum[re_count] / total_test_data_count,NDCGSum[re_count] / total_test_data_count,OneCallSum[re_count] / total_test_data_count
